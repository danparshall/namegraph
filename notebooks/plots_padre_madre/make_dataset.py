...
def main(filepath_raw="/home/juan.russy/shared/FamilyNetwork/original/RC_v2021.tsv", folder_interim='/home/juan.russy/shared/proof_run_FamNet/interim/'):
    """ Runs data processing scripts to turn raw data from (../raw) into
        cleaned data ready to be analyzed (saved in ../interim).
    """
    # ## STUFF FROM NB 1.0
    # print("Loading registry")
    # rf = cleanup.load_registry(filepath_raw)
    ...
    # new #
    rf = test_data(folder_interim + '01-rf.tsv',
                   utils.get_dtypes_reg(), utils.get_date_cols())
    parsed = test_data(folder_interim + '05-newfreqfile.tsv',
                       utils.get_dtypes_newfreqfile())
    padre = test_data(folder_interim + '07-padre.tsv',
                      utils.get_dtypes_padres())
    matched_padres = pd.read_csv(
        folder_interim + '09-matched_padres.tsv', sep='\t')
    # new #
